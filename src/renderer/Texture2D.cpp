...
namespace Renderer
{
	Texture2D::Texture2D(const GLuint wight, GLuint height,
	...
	{	
		...
		glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, m_wight, m_height, 0, GL_RGB, GL_UNSIGNED_BYTE, data);
